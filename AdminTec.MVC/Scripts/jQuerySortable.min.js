 ...
 * @license MIT
 */
(function(n){"use strict";typeof define=="function"&&define.amd?define(["jquery"],n):n(jQuery)})(function(n){"use strict";n.fn.sortable=function(t){var i,r=arguments;return this.each(function(){var f=n(this),u=f.data("sortable");if(!u&&(t instanceof Object||!t)&&(u=new Sortable(this,t),f.data("sortable",u)),u){if(t==="widget")return u;t==="destroy"?(u.destroy(),f.removeData("sortable")):typeof u[t]=="function"?i=u[t].apply(u,[].slice.call(r,1)):t in u.options&&(i=u.option.apply(u,r))}}),i===void 0?this:i}});
/*! tether 1.1.0 */
